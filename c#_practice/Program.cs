...
//ternary operator / inlinecondition
var inLineCondition = 3 > 2 ? 10 : 5; // this will return 10 because it is true
Console.WriteLine(inLineCondition);

//I love heated discussion
var inLineStatementTwo = 3 > 2 ? 10 : 6; // will evaluate to true
var inLineStatementFalse = 3 < 2 ? 10 : 4; // will evaluate to false
